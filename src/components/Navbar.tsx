    ...
    return (
        <div className="flex flex-row items-center pt-12 ">
            ...
            <span className="flex gap-5 flex-row self-end ml-16 text-lg font-semibold text-white">
                <a href="/product" className="flex items-center">Product<Arrow /></a>
                <a href="/company" className="flex items-center">Company <Arrow /></a>
                <a href="/connect" className="flex items-center">Connect <Arrow /></a>
            </span>
